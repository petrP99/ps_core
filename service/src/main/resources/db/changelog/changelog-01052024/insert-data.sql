...
INSERT INTO card (id, client_id, balance, created_date, expire_date, name, currency, status)
VALUES
    (100001, 1, 2150.50, '2025-01-16', '2028-01-16', NULL, 'RUB', 'BLOCKED'),
    (100002, 1, 3270.25, '2025-02-10', '2029-02-10', 'зарплатная', 'USD', 'ACTIVE'),
    -- Client 2 (Maria)
    (100003, 2, 8730.50, '2025-02-21', '2028-02-21', 'основная', 'RUB', 'ACTIVE'),
    (100004, 2, 1540.75, '2024-12-01', '2027-12-01', NULL, 'RUB', 'EXPIRED'),
    -- Client 3 (Alexey)
    (100005, 3, 1800.00, '2025-03-11', '2028-03-11', 'для покупок', 'RUB', 'ACTIVE'),
    (100006, 3, 1450.00, '2025-03-11', '2029-03-11', NULL, 'RUB', 'EXPIRED'),
    -- Client 4 (Elena)
    (100007, 4, 5200.00, '2025-01-06', '2028-01-06', 'накопления', 'USD', 'ACTIVE'),
    (100008, 4, 7780.25, '2025-01-06', '2027-01-06', 'резервная', 'RUB', 'ACTIVE'),
    -- Client 5 (Dmitry)
    (100009, 5, 4120.80, '2025-04-13', '2028-04-13', NULL, 'RUB', 'BLOCKED'),
    (100010, 5, 2630.00, '2025-04-13', '2029-04-13', NULL, 'RUB', 'EXPIRED'),
    -- Client 6 (Olga)
    (100011, 6, 2890.00, '2025-03-01', '2028-03-01', 'повседневная', 'RUB', 'ACTIVE'),
    (100012, 6, 1560.00, '2025-03-01', '2027-03-01', 'для путешествий', 'RUB', 'ACTIVE'),
    -- Client 7 (Sergey)
    (100013, 7, 5670.45, '2025-03-26', '2028-03-26', 'зарплатная', 'RUB', 'ACTIVE'),
    (100014, 7, 3250.00, '2025-03-26', '2029-03-26', 'сбережения', 'RUB', 'ACTIVE'),
    -- Client 8 (Anna)
    (100015, 8, 980.90, '2025-01-21', '2028-01-21', NULL, 'RUB', 'EXPIRED'),
    (100016, 8, 1170.00, '2025-01-21', '2027-01-21', 'студенческая', 'RUB', 'ACTIVE'),
    -- Client 9 (Pavel)
    (100017, 9, 8950.00, '2025-04-06', '2028-04-06', NULL, 'RUB', 'BLOCKED'),
    (100018, 9, 6720.00, '2025-04-06', '2029-04-06', 'бизнес', 'USD', 'ACTIVE'),
    -- Client 10 (Natalia)
    (100019, 10, 4310.60, '2025-02-16', '2028-02-16', NULL, 'RUB', 'BLOCKED'),
    (100020, 10, 3520.00, '2025-02-16', '2027-02-16', 'основная', 'RUB', 'ACTIVE');
